...
var App = (function () {
    function App(params) {
        ...
        createjs.Ticker.on('tick', function () {
            ...
            if (nextAction) {
                _this.moveAvatar(myId, nextAction);
                return;
            } else {
